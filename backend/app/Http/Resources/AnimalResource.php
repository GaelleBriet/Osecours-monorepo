...
class AnimalResource extends JsonResource
{
    public function toArray($request)
    {
        return [
            ...
            'sizerange' => $this->size_range ? ["name"=> $this->size_range->name, "id" => $this->size_range->id]: null,
            'agerange' => $this->age_range ? ["name"=> $this->age_range->name, "id" => $this->age_range->id]: null,
