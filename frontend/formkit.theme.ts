...
const classes: Record<string, Record<string, boolean>> = {
	...
	'family:box__input': {
		...
		'dark:[color-scheme:dark]': true,
		'selection:bg-blue-100': true,
		'selection:text-neutral-500': true,
		'group-data-[has-overlay]:selection:!text-transparent': true,
		peer: true,
	...
	'family:dropdown__listbox': {
		...
		'group-data-[overscroll]:dark:border-neutral-300': true,
	},
	...
	select__option: {
		...
		'group-data-[multiple]:checked:bg-blue-100': false,
		'group-data-[multiple]:focus:bg-blue-100': false,
