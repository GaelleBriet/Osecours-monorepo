...
<template>
	<div class="shelter-documents h-full">
		<h1 class="text-base leading-6 text-gray-900 mb-2">Add a new photo</h1>
		<p class="my-2 text-sm text-gray-700">
			You can add multiple photos. All of them would have the same name and
			description.
		</p>
		<!-- @todo: changer l'info pour recuperer les photos du shelter'  -->
		<Form
			:id="`edit-shelter-photos${localShelter.id}`"
			:submit-label="'edit-shelter-photos'"
			:actions="false"
		>
			<div class="h-full">
