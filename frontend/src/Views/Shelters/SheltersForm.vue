<script setup lang="ts">
	...
	const onSubmit = async () => {
		if (props.isCreateMode) {
			const newShelter = await sheltersStore.createShelter(createdShelter.value);
		}
		if (!props.isCreateMode) {
		...
		>
			...
			<div className="grid lg:grid-cols-2 lg:grid-rows-2 gap-4">
				...
				<div class="lg:col-start-2 lg:row-start-1">
					<FormText
						id="shelter-siret"
						:model-value="!isCreateMode ? shelter.siret : createdShelter.siret"
						:name="'shelter-siret'"
				...
				<div class="col-start-1 lg:row-start-2">
					<FormText
						id="shelter-email"						
						:model-value="!isCreateMode ? shelter.email : createdShelter.email"
						:name="'shelter-email'"
				...
				<div class="lg:col-start-2 lg:row-start-2">
					<FormText
						id="shelter-phone"						
						:model-value="!isCreateMode ? shelter.phone : createdShelter.phone"
				...
				<div class="lg:col-span-2 lg:col-start-1 lg:row-start-3 ">
					<FormTextArea
						...
						:model-value="!isCreateMode ? shelter.description : createdShelter.description"
			...
			<div
				class="my-1 row-start-2 lg:row-start-2"
			>
