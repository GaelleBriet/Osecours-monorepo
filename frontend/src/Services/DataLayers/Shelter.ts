...
: Promise<Shelter | ErrorResponse> => {
	try {
			const response = {
				...
				description: 'Pellentesque auctor neque nec urna. Curabitur at lacus ac velit ornare lobortis.',
	...
	try {
		const shelters: Shelter[] = [
			...
			},
			{
				...
				description: 'Duis leo. Curabitur at lacus ac velit ornare lobortis. Nam pretium turpis et arcu.',
			...
			},
			{
				...
				description: 'Praesent nec nisl a purus blandit viverra. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Duis lobortis massa imperdiet quam. Nam adipiscing.',
