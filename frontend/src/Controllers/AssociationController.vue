...
<template>
	<div class="container">
		<div class="grid grid-cols-3 grid-rows-1 gap-4">
			<div class="text-2xl mb-1 col-span-2">
		...
		<TabsComponent id="associationsTabsComponent" :tabs="[
					{ name: getCapitalizedText(t('pages.animals.details')) },
					{ name: getCapitalizedText(t('navigation.all-associations')) },
		...
		<div class="content">
			...
			<template v-if="currentTab === 1 && currentAssociation">
				<DataGridComponent :store="associationsStore" :model-value="associationsTransformed" :columns="[
